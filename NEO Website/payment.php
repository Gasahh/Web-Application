   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='order-detail'>
            ...
            <span class='total'> total : MYR ".$price_total."  </span>
         </div>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : MYR<?= $grand_total; ?> </span>
   </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. telok mas" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. melaka" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
         ...
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="e.g. 75050" name="pin_code" required>
         </div>
      </div>
